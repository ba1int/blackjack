...
def game():
    ...
    while bankroll > 0:
        ...
        if calculate_value(player_hand) == 21:
            ...
            while True:
                choice = input("\nDo you want to hit (h), stand (s), or double down (d)? ").lower()
                ...
                if choice == 'h' or choice == 'hit':
                    ...
                    if calculate_value(player_hand) > 21:
                        ...
                        break  # Automatically proceed to the dealer's turn
                    ...
                    print("Invalid choice. Please choose 'h' to hit, 's' to stand, or 'd' to double down.")
        ...
        print(f"Cards left in the deck: {deck_counter}")
