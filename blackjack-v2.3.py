...
def game():
    ...
    while bankroll > 0:
        ...
        bet_input = input(f"Current bankroll: ${bankroll:.2f}. Enter your bet (type 'exit' to quit): ")
                ...
                if choice == 'h' or choice == 'hit':
                    ...
                    if split_pair(player_hand, split_hands, deck):
                        ...
                        for i, hand in enumerate(split_hands):
                            ...
                            display_hand(hand, is_dealer=False)
        ...
        print(f"Cards left in the deck: {deck_counter:.0f}")
